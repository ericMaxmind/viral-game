<div id="appCapsule">
        ...
        <div class="section mt-2">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Nous vous offrons</h5>
                    <p class="card-text d-none">Some quick example text to build on the card title and make up the bulk of the
                        card's content.</p>
                </div>
            </div>
        </div>
                ...
                <div class="col-6">
                    <div class="card product-card">
                        <div class="card-body">
                            ...
                            <p class="text">1 kg</p>
                            <div class="price">78 dhs</div>
                            <a href="#" class="btn btn-sm btn-primary btn-block">PROFITEZ</a>
                        </div>
                    </div>
                </div>
                <div class="col-6">
